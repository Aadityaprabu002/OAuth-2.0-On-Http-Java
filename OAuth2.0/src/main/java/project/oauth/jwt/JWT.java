...
public class JWT{
	...
	public boolean hasTokenExpired(String jwtToken)  throws InvalidKeyException, NoSuchAlgorithmException, ParseException{
		JSONParser jsonParser  = new JSONParser();
		...
		if(nowDate.compareTo(expDate) > 1) {
			return true;
		}
		return false;
	}
